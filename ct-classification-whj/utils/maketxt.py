...
# make txt file
def write_txt(file_path, txt_name, test_percent):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path', '--f', type=str, default='D:/Download/data/COVID-19 Dataset/ct/', help='file path')
    parser.add_argument('--txt_name', '--t', type=str, default='test.txt', help='output file name')
    ...
    parser.add_argument('--file_type', type=str, default='.jpeg', help='file type such as:.jpg')
    parser.add_argument('--options', '--o', type=str, default='write', help='options rename or write')
