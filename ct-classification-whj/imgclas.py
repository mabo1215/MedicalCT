...
if __name__ == "__main__":
    ...
    parser.add_argument('--save-dir', type=str, default="./checkpoint/CodeDes/", help="")
    parser.add_argument("--cuda", action="store_false", help="Avoid using CUDA when available")
    ...
    dev = 1 if torch.cuda.is_available() and args.cuda else 0
